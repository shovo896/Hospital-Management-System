...
// ============================================
// OLD PATIENT AUTH FUNCTIONS (TO BE REMOVED)
// ============================================

// These old functions are being replaced by new unified auth system
...
function updatePatientAuthButton() {
    // Deprecated - use updateNavigationForRole()
}
...
function showLoginForm() {
    // Old function - not needed with unified login
    backToLogin();
}

function showRegistrationForm() {
    // Old function - handled in unified login
    // Kept for backward compatibility but redirects to new system
}

// Patient Login Form Handler (OLD - REMOVED)
// Old patient login form - now using unified-login-form

// Old admin login form - now using unified login system
// document.getElementById('admin-login-form') is now handled by unified-login-form

function updateAdminButton() {
    // Deprecated - navigation updates handled by updateNavigationForRole()
}

function logoutAdmin() {
    // Deprecated - using unified logout() function
    logout();
}

// Old registration form - now using unified-register-form
...
document.getElementById('diagnostic-form')?.addEventListener('submit', function(e) {
    ...
    // Reload if on patient appointments tab
    if (currentRole === 'patient' && document.getElementById('patient-appointments').classList.contains('active')) {
        loadPatientAppointments();
    }
